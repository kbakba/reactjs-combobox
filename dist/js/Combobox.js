...
NS.Combobox = (function(React) {
    ...
    var ComboboxOption = React.createClass({displayName: 'ComboboxOption',
        ...
        render: function() {
            ...
            return (
                React.DOM.li( {className:cx(cls), onClick:this.onClick}, 
                    this.props.children
                )
            );
        },
    ...
    var Combobox = React.createClass({displayName: 'Combobox',
        ...
        render: function() {
            ...
            if (this.state.isEnabled) {
                dropdown = (
                    React.DOM.div( {className:clsElem('dropdown')}, 
                        React.DOM.div( {className:clsElem('dropdownWrapper')}, 
                            React.DOM.ul( {className:clsElem('dropdownList')}, 
            ...
            return (
                React.DOM.div( {className:cx(cls) + ' ' + this.state.additionalClassName,
                    ...
                    React.DOM.input(
                        ...
                        onFocus:this._focus}),
                    dropdown,
                    React.DOM.span( {className:clsElem('buttonWrapper')}, 
                        React.DOM.button(
                            {ref:"button",
                            type:"button",
